...
const en: Dictionary = {
  ...
  admin: {
    ...
    settings: {
      ...
      bmProviderHint: "Twilio credentials are configured on the server only — never shown here.",
      bmTwilioTest: "Test Twilio",
      bmTwilioTesting: "Testing…",
      bmTwilioTestSuccess: "Twilio connection successful.",
      bmTwilioTestError: "Twilio test failed.",
