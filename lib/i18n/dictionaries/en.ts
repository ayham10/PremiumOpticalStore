...
const en: Dictionary = {
  ...
  admin: {
    ...
    bookings: {
      ...
      manualKicker: "Manual booking",
      manualTitle: "New appointment",
      availableTime: "Available time",
      notes: "Notes (optional)",
      notesPlaceholder: "Private note for staff only",
      confirmBooking: "Confirm booking",
      confirming: "Confirming…",
      loadingDates: "Loading dates…",
      noDates: "No open dates for this service.",
    ...
    availability: {
      title: "Working Hours",
      description:
        "Exceptions-only schedule — edit working periods for specific dates",
      refresh: "Refresh",
      addSlot: "Add available time",
      addDate: "Add available date",
      guide: "Select a date, then edit working periods",
      today: "Today",
      prevMonth: "Previous month",
      nextMonth: "Next month",
      legendOpen: "Open",
      ...
      legendException: "Custom",
      noDate: "No date selected",
      noDateLead: "Pick a date on the calendar to edit its working hours.",
      ...
      markOpen: "Reopen",
      copySchedule: "Copy from another date",
      copyPrevious: "Copy from another day",
      copyPreviousDay: "Copy Previous Day",
      copyFromAnother: "Copy From Another Date",
      addTime: "Add Time",
      addNew: "Add new",
      ...
      scheduleTitle: "Working periods",
      scheduleLead: "Edit start/end periods below, then save to apply as an exception.",
      dayOpenBanner: "This day is open for booking",
      dayOpenLead: "Customers can book within the working periods below.",
      dayClosedBanner: "This day is closed",
      dayClosedLead: "Reopen the day to allow customers to book.",
      slotTip: "Click any time to edit it or change its status.",
      periodTip:
        "Changes stay local until you save. Saving marks this date as a custom exception.",
      legendLimited: "Bookings",
      timeLabel: "Time",
      startTime: "Start Time",
      endTime: "End Time",
      enablePeriod: "Enable",
      deletePeriod: "Delete",
      noPeriods: "No working periods yet. Add a time range to open bookings.",
      noPreviousDay: "No earlier day with a schedule was found.",
      exceptionBadge: "Custom hours",
      bookedSummary: "{n} booked · {times}",
      ...
      copyOverwrite:
        "This overwrites working periods and open/closed state on the selected date.",
      confirm: "Confirm",
    ...
    settings: {
      ...
      hoursErrorInvalidRange: "Each period must end after it starts.",
      hoursErrorOverlap: "Periods cannot overlap.",
      hoursErrorMaxPeriods: "Maximum 3 periods per day.",
      ...
      bmOracleWaiting: "Waiting for WhatsApp connection",
      bmOracleDisconnected: "Disconnected",
      bmOracleUnavailable: "Service unavailable",
      bmOracleTest: "Test Connection",
      bmOracleTesting: "Testing…",
      bmOracleTestSuccess: "WhatsApp Web service is reachable.",
      bmOracleTestError: "Could not reach the WhatsApp Web service.",
      bmOracleConnect: "Connect WhatsApp",
      bmOracleConnecting: "Loading QR…",
      bmOracleRefresh: "Refresh status",
      bmOracleRefreshing: "Refreshing…",
      bmOracleQrHint:
        "Scan this QR with WhatsApp → Linked Devices. It refreshes until the session is READY.",
      bmOracleQrAlt: "WhatsApp connection QR code",
      bmOracleQrError: "Could not load the WhatsApp QR code.",
      bmOracleFreshQr: "Generate Fresh QR",
      bmOracleFreshQrLoading: "Generating a new QR…",
      bmOracleFreshQrError: "Could not generate a fresh WhatsApp QR.",
      bmOracleReset: "Reconnect WhatsApp",
      bmOracleResetLoading: "Reconnecting…",
      bmOracleResetError: "Could not reconnect WhatsApp.",
      bmOracleResetTitle: "Reconnect WhatsApp?",
      bmOracleResetConfirm:
        "This restarts the WhatsApp Web client without deleting the saved session. If the session is still valid it should return to READY; otherwise a QR will appear.",
      bmOracleResetConfirmAction: "Reconnect",
      bmOracleResetCancel: "Cancel",
      bmOracleLinkNew: "Reset / Link New WhatsApp",
      bmOracleLinkNewLoading: "Resetting session…",
      bmOracleLinkNewError: "Could not reset the WhatsApp session.",
      bmOracleLinkNewTitle: "Reset and link a new WhatsApp?",
      bmOracleLinkNewConfirm:
        "This deletes the saved WhatsApp Web session on the server. You must scan a new QR with WhatsApp → Linked Devices to connect or replace the account.",
      bmOracleLinkNewConfirmAction: "Reset and link new",
      bmOracleDisconnect: "Disconnect WhatsApp",
      bmOracleDisconnectLoading: "Disconnecting…",
      bmOracleDisconnectError: "Could not disconnect WhatsApp.",
      bmOracleDisconnectTitle: "Disconnect WhatsApp?",
      bmOracleDisconnectConfirm:
        "This unlinks the current WhatsApp Web session. A new QR must be scanned to connect again.",
      bmOracleDisconnectConfirmAction: "Disconnect",
      ...
      bmHoursBefore: "Hours before appointment",
      bmReminderTime: "Reminder time",
      bmReminderMin15: "15 minutes",
      bmReminderMin30: "30 minutes",
      bmReminderMin45: "45 minutes",
      bmReminderMin60: "1 hour",
      bmReminderMin90: "1 hour 30 minutes",
      bmReminderMin120: "2 hours",
