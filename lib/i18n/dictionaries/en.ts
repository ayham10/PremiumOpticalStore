...
const en: Dictionary = {
  ...
  admin: {
    ...
    settings: {
      ...
      bmOracleReset: "Reset WhatsApp Session",
      bmOracleResetLoading: "Generating new QR…",
      bmOracleResetError: "Could not reset the WhatsApp session.",
      bmOracleResetTitle: "Reset WhatsApp session?",
      bmOracleResetConfirm:
        "This removes the old linked WhatsApp Web session on the server. A new QR must be scanned with WhatsApp → Linked Devices. A working connection is not reset automatically.",
      bmOracleResetConfirmAction: "Reset session",
