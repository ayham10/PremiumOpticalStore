...
const en: Dictionary = {
  ...
  admin: {
    ...
    settings: {
      ...
      bmOracleResetLoading: "Generating new QR…",
      bmOracleResetError: "Could not reconnect WhatsApp.",
      bmOracleResetTitle: "Reconnect WhatsApp?",
      bmOracleResetConfirm:
        "This removes the old linked WhatsApp Web session on the server. Scan a new QR with WhatsApp → Linked Devices to connect or replace the account.",
