...
export const SEED_STAFF: StaffMember[] = [
  {
    ...
    role: "admin",
    title: "Store Manager",
    bio: "Store operations, fittings coordination, and customer care.",
  ...
  },
  {
    ...
    role: "receptionist",
    title: "Front Desk",
    bio: "Appointments, fittings coordination, and customer care.",
...
export const SEED_PRODUCTS: Product[] = [
  ...
  {
    id: "prod-11",
    slug: "eclipse-black-aviator",
    name: "Eclipse Black Aviator",
    category: "Sunglasses",
    brand: "Horizon",
    frameType: "Aviator",
    lensType: "Polarized UV400",
  ...
  {
    id: "prod-13",
    slug: "marina-gold-rim",
    name: "Marina Gold Rim",
    category: "Sunglasses",
    brand: "Nordic Line",
    frameType: "Oval",
    lensType: "Polarized UV400",
